													 ...
													 (cp,
													  ...
													  (cp,
													   ...
													   (cp,
													    ...
													    AddOps
													    (cp,
													     REG_INVINSTCACHELNMVA
													     AddOps
													     (cp,
													      REG_INVINSTCACHELNIDX
													      AddOps
													      (cp,
													       REG_FLUSHPREFETCH
													       AddOps
														...
														(cp,
														 ...
														 (cp,
														  ...
														  AddOps
														  (cp,
														   REG_INVDATACACHLNEMVA
														   AddOps
														   (cp,
														    REG_INVDATACACHLNEIDX
														    AddOps
														    (cp,
														     REG_INVCACHES
														     AddOps
															   ...
															   (cp,
															    ...
															    (cp,
															     ...
															     (cp,
															      ...
															      AddOps
															      (cp,
															       REG_CLEANDATACACHELNMVA
															       AddOps
															       (cp,
																REG_CLEANDATACACHELNIDX
																AddOps
																(cp,
																 REG_DATASYNCBARRIER
																 AddOps
																  ...
																  (cp,
																   ...
																   (cp,
																    ...
																    (cp,
																     ...
																     AddOps
																     (cp,
																      REG_CLINVDATACACHEMVA
																      AddOps
																      (cp,
																       REG_CLINVDATACACHEIDX
																       AddOps
																       (cp,
																	REG_INVITLBUNLCKD
																	AddOps
																							 ...
																							 (cp,
																							  ...
																							  (cp,
																							   ...
																							   (cp,
																								...
																								AddOps
																								(cp,
																								 REG_INSTCACHEMSTRVALID
																								 AddOps
																								 (cp,
																								  REG_DATACACHEMASTERVAL
																								  AddOps
																								  (cp,
																								   REG_TLBLKDWNIDX
																								   AddOps
